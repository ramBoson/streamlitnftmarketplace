...
if "admin" not in st.session_state:
    ...
    st.session_state.admin = ('+FItTCe6NXWiIccpPYbgJAHkfDr1+AdNIx8B+YOvlGgIM3fchnlh9NXZ+HNMK34l1xBYX2ANt2pPHZlRYGyKxA==','BAZXPXEGPFQ7JVOZ7BZUYK36EXLRAWC7MAG3O2SPDWMVCYDMRLCHC6JC2U')
    print("account",st.session_state.admin)
...
if "buyer_1" not in st.session_state:
    ...
    st.session_state.buyer_1 = ('61XY/NzQ8OSd1FnbxbZ0pyuDOdpks+r9K0mQ79grcH6MrT1myBvxNfLX01iK2g4ophURkBXC1h2z427mDk0k/Q==','RSWT2ZWIDPYTL4WX2NMIVWQOFCTBKEMQCXBNMHNT4NXOMDSNET66YBZT5Y')
    print("accountbuyer",st.session_state.buyer_1)
